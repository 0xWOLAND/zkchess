...
contract SignupNonAnonVerifier {
    ...
    function verifyingKey() internal pure returns (VerifyingKey memory vk) {
        ...
        vk.IC[0] = Pairing.G1Point(uint256(15631515477469390305103792460620143569342174962134430507503043655870622935870),uint256(19232070640400569097517019114298688049973566676359486787279955764184936343642));
        vk.IC[1] = Pairing.G1Point(uint256(17882351432929302592725330552407222299541667716607588771282887857165175611387),uint256(18907419617206324833977586007131055763810739835484972981819026406579664278293));
