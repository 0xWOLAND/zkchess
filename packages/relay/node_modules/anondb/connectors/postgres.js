...
class PostgresConnector extends types_1.DB {
    constructor(config) {
        super();
        this.schema = {};
    ...
    _update(collection, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { rowCount } = yield this.db.query(sql);
            return rowCount;
        });
    }
    ...
    createTables(tableData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.db.query(createTablesCommand);
        });
    }
    ...
    _transaction(operation, onComplete) {
        ...
        ${sqlOperations.join('\n')}
        COMMIT;`;
                        yield this.db.query(transactionSql);
                    }
                    catch (err) {
